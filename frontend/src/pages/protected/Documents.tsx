            ...
            <tbody className="divide-y divide-gray-100">
              {filteredDocs.length > 0 ? (
                filteredDocs.map((doc) => (
                  <tr key={doc.id} className="group hover:bg-gray-50/70 transition-colors">
                    {/* Details Column */}
                    <td className="px-6 py-4">
                      <div className="flex items-start gap-3">
                        <div className="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex flex-col items-center justify-center shrink-0 border border-red-100 relative shadow-sm">
                          <FileText size={18} />
                          <span className="text-[7px] font-bold absolute bottom-0.5 tracking-tight uppercase">PDF</span>
                        </div>
                        <div className="space-y-1">
                          <h3 className="text-[14px] font-bold text-gray-900 group-hover:text-indigo-600 transition-colors pr-4">
                            {doc.title}
                          </h3>
                          <div className="flex items-center gap-2">
                            <span className="text-[11px] font-mono font-medium text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200/50">
                              {doc.id}
                            </span>
                            {doc.circularNumber !== 'N/A' && (
                              <span className="text-[11px] font-mono font-medium text-indigo-600 bg-indigo-50/50 px-1.5 py-0.5 rounded border border-indigo-100/50">
                    ...
                    <td className="px-6 py-4 align-middle text-right">
                      <div className="inline-flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 text-[12px] font-semibold transition-colors cursor-pointer shadow-sm"
                        >
                          <Eye size={14} />
                          View
                        </button>
        ...
        <div className="fixed inset-0 z-50 overflow-hidden" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              <div className="pointer-events-auto w-screen max-w-md transform bg-white shadow-xl transition-all duration-300 ease-in-out border-l border-gray-200">
                <div className="flex h-full flex-col overflow-y-scroll bg-white">
                  {/* Drawer Header */}
                  <div className="bg-gray-50 border-b border-gray-200 px-6 py-5">
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <span className="inline-flex items-center rounded-md bg-indigo-50 px-2 py-0.5 text-[11px] font-mono font-medium text-indigo-700 ring-1 ring-inset ring-indigo-700/10">
                          {selectedDoc.id}
                        </span>
                  ...
                  <div className="flex-1 px-6 py-6 space-y-6">
                    {/* Metadata Grid */}
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-200/60 grid grid-cols-2 gap-y-4 gap-x-6">
                      <div>
                    ...
                    <div className="space-y-3 border-t border-gray-100 pt-5">
                      <div className="flex items-center gap-2 text-red-700 bg-red-50 border border-red-200/50 p-3 rounded-lg">
                      ...
                      <div className="flex items-center gap-2 text-gray-700 bg-gray-50 border border-gray-200/50 p-3 rounded-lg">
                    ...
                    <div className="space-y-2 border-t border-gray-100 pt-5">
                      ...
                      <div className="border border-gray-200 rounded-lg p-4 bg-gray-900 text-gray-100 font-mono text-[11px] h-44 overflow-y-auto leading-relaxed select-none">
                  ...
                  <div className="border-t border-gray-200 px-6 py-5 bg-gray-50 flex items-center justify-end gap-3">
                    <button
                      onClick={() => setSelectedDoc(null)}
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#030213] text-white hover:bg-opacity-90 rounded-lg text-[13px] font-semibold transition-colors flex items-center gap-2 cursor-pointer shadow-sm"
                    >
                      <Download size={14} />
                      Download Document
                    </button>
            ...
            <div className="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-gray-200">
              <div className="bg-white px-6 pb-6 pt-5">
                ...
                <form onSubmit={handleUploadSubmit} className="mt-4 space-y-4">
                  ...
                  {/* Fake File Selection */}
                  <div className="border border-dashed border-gray-200 rounded-lg p-5 bg-gray-50 hover:bg-gray-100/50 transition-colors flex flex-col items-center justify-center text-center cursor-pointer select-none">
