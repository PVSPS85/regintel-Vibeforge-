...
interface RequestAccessFormValues {
  fullName: string;
  email: string;
  branchCode: string;
  password: string;
...
const RequestAccess = () => {
  ...
  } = useForm<RequestAccessFormValues>({ mode: 'onTouched' });
        ...
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[14px] text-gray-500">
              Register for a new RegIntel workspace account.
            </p>
          </div>
          ...
          >
            ...
            <div className="space-y-1.5">
              ...
              {errors.fullName && (
                <p id="register-name-err" role="alert" className="text-[12px] text-red-500 font-medium">
            ...
            <div className="space-y-1.5">
              ...
              {errors.email && (
                <p id="register-email-err" role="alert" className="text-[12px] text-red-500 font-medium">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                ...
                <div className="group relative flex items-center">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 hidden w-48 p-2 bg-gray-900 text-white text-[11px] font-medium rounded shadow-lg group-hover:block z-10 text-center">
                    Required for branch-based access control. Check with your Branch Manager if unsure.
              ...
              <div className="relative">
                ...
                <input
                  id="register-branch"
                  type="text"
                  placeholder="e.g. BRN-042"
                  aria-invalid={!!errors.branchCode}
                  aria-describedby={errors.branchCode ? 'register-branch-err' : undefined}
                  className={`
                    w-full h-11 pl-10 pr-4 rounded-lg border text-[14px] text-gray-900
                    bg-gray-50 placeholder:text-gray-400 outline-none
                    transition-[border-color,box-shadow] duration-150
              ...
              {errors.branchCode && (
                <p id="register-branch-err" role="alert" className="text-[12px] text-red-500 font-medium">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  aria-describedby={errors.password ? 'register-pw-err' : undefined}
                  className={`
              ...
              {errors.password && (
                <p id="register-pw-err" role="alert" className="text-[12px] text-red-500 font-medium">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[12px] text-gray-400 font-medium">Have an account?</span>
            <div className="flex-1 h-px bg-gray-100" />
          </div>
